...
Route::get('gallery', array('as' => 'gallery', 'uses' => 'JeroenG\LaravelPhotoGallery\Controllers\GalleryController@index', 'before' => 'auth'));

Route::group(array('prefix' => 'gallery', 'before' => 'auth'), function()
{
