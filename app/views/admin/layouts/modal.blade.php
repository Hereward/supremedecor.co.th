...
<body>
	...
	<!-- Javascripts -->
    <script src="{{asset('assets/wysihtml5x/dist/wysihtml5x-toolbar.min.js')}}"></script>
    ...
    <script src="{{asset('assets/handlebars/handlebars.runtime.min.js')}}"></script>
    <script src="{{asset('assets/bootstrap3-wysihtml5-bower/dist/bootstrap3-wysihtml5.min.js')}}"></script>
